...
class BT_ObjectDetector:
    def __init__(self):
        self.model_path="C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\best_tumor.pt"
        self.model = YOLO(self.model_path)
        self.class_list = self._load_class_labels('C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\coco_BT.txt')
        self.output_dir = "C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\output_OBJ"
...
# image = Image.open('/home/faizah.kureshi@corp.merillife.com/Downloads/hackathon/BTM/Dataset_lrp_training/Training/no_tumor/image (18).jpg')
# detector = BT_ObjectDetector()
# output_pathforalzh=detector.process_image(image)