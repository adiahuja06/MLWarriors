...
if uploaded_file is not None:
    ...
    if model_choice == 'MRI (Brain Tumor)':
        ...
        model_path = "C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\best_model_BT.pth"
        ...
        model_path = "C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\best_model_alzhimers.pth"
...
#     # Display XIA result
#     st.image(xia_result, caption='XIA Result', use_column_width=True)

# def transform_image_to_tensor(image):
#     # Implement the transformation from image to tensor based on your model requirements
#     pass
