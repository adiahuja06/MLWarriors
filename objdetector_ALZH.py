...
class AL_ObjectDetector:
    def __init__(self):
        self.model_path="C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\best_alzh.pt"
        self.model = YOLO(self.model_path)
        self.class_list = self._load_class_labels('C:\\Users\\ahuja\\OneDrive\\Desktop\\Try\\interface\\coco_ALZH.txt')
...
# image = Image.open('/home/faizah.kureshi@corp.merillife.com/Downloads/hackathon/frontend/OAS1_0003_MR1_mpr-1_110.jpg')
